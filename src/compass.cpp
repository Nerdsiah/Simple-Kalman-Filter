...
float compass_x_gainError=1,compass_y_gainError=1,compass_z_gainError=1,heading=0;
int16_t compass_x=0,compass_y=0,compass_z=0;
uint8_t compass_debug=0;
...
void compass_heading(){
  ...
  if (compass_y_scalled>0){
    heading = 90-atan(compass_x_scalled/compass_y_scalled)*compass_rad2degree;
  }else if (compass_y_scalled<0){
    heading = 270-atan(compass_x_scalled/compass_y_scalled)*compass_rad2degree;
